...
app.get('/geo', function(req, res){
	...
	geopath += "&key=AIzaSyBX-2M4rVMh_8V-cPkh5fvtb2DrNTCa-t4";
...
app.get('/nearby',function(req,res){
	...
	nearbypath += "&key=AIzaSyBX-2M4rVMh_8V-cPkh5fvtb2DrNTCa-t4";
...
app.get('/detail',function(req,res){
	...
	detailpath += "&key=AIzaSyBX-2M4rVMh_8V-cPkh5fvtb2DrNTCa-t4";
	//console.log(host+nearbypath);
...
app.get('/page', function(req,res){
	...
	pagepath += "&key=AIzaSyBX-2M4rVMh_8V-cPkh5fvtb2DrNTCa-t4";
